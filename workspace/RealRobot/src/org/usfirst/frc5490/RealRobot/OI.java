...
import edu.wpi.first.wpilibj.Joystick.getY;
import edu.wpi.first.wpilibj.Joystick.getX;
...
public class OI {
    ...
    public OI() {
        ...
        joystick = new Joystick(0, 2);
        
        liftLevel1 = new JoystickButton(joystick, 6);
        ...
        this.yValue = joystick.getY();
        
        this.xValue = joystick.getX();
