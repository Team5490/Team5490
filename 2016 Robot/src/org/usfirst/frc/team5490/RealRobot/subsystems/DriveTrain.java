...
public void drive()  {  //drive method
    ...
    this.throttleValue = -2*throttleValue+3;
...
=======
        this.rightSpeed = rightSpeed - Math.pow(xSteer, throttleValue/10);
>>>>>>> 50d862129831b0bbd6f9771b6457e36518c7d39b
    }
    if (xSteer < 0) {
        this.leftSpeed = leftSpeed - Math.pow(xSteer, throttleValue)/10;
        this.rightSpeed = rightSpeed + Math.pow(xSteer, throttleValue)/10;
    ...
    if (xSteer > 0.4 && driveSpeed < 0.1 && driveSpeed > -0.1)  {
        this.leftSpeed = xSteer/3;
        this.rightSpeed = -xSteer/3;
    }
    if (xSteer < -0.4 && driveSpeed < 0.1 && driveSpeed > -0.1)  {
        this.leftSpeed = -xSteer/3;
        this.rightSpeed = xSteer/3;
